...
import typesvg from '../../assets/typewriter.svg'


export default function BrackForm() {
    const [selectedDate, setSelectedDate] = React.useState(new Date());
    const [value, setSelectedValue] = React.useState(new Boolean);
                ...
                <Row className="d-flex flex-wrap">
                    <Col>
                        <CheckboxToggle
                            ...
                            label={<div className="Form" style={{ color: "white" }}>Randomize</div>}
                            labelAlignment="left"
                            value={value}
